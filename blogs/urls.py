...
from . import views
from .views import BlogView, HomeView, AddBlogView, UpdateBlogView, DeleteBlogView, BlogLikeRedirect
...
urlpatterns = [
    ...
    path('blogpost-like/<slug>', BlogLikeRedirect.as_view(), name="blogpost_like"),
]
